...
class TestQMIXCritic(unittest.TestCase):
    def setUp(self):
        ...
        qmix_hidden_dim = 128
        hyper_hidden_dim = 64
        self.critic = QMIXCritic(state_shape, n_agents, qmix_hidden_dim, hyper_hidden_dim)

    def test_forward_pass(self):
        # Create dummy input data
        batch_size = 10
        q_values = torch.randn(batch_size, self.critic.n_agents)
    ...
    def test_hyper_networks(self):
        ...
        # Check shapes
        self.assertEqual(w1.shape, (batch_size, self.critic.n_agents * self.critic.qmix_hidden_dim))
