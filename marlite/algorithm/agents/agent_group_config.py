...
def create_ssl_gc_mappo_agent_group(
    agent_group_config: Dict[str, Any],
) -> GroupConsensusMAPPOAgentGroup:
    """Create a GroupConsensusMAPPOAgentGroup from config."""
    return _create_group_consensus_agent_group(
        GroupConsensusMAPPOAgentGroup, agent_group_config
    )
...
registered_agent_groups = {
    ...
    "GroupConsensusMAPPO": create_ssl_gc_mappo_agent_group,
    "SSLGroupConsensusMAPPO": create_ssl_gc_mappo_agent_group,
}
