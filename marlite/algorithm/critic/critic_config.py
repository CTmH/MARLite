...
def create_qplex_mixer(critic_config: Dict[str, Any]) -> QPLEXMixer:
    """Create a QPLEXMixer critic instance from config."""
    critic_config = dict(critic_config)
    feature_extractor = critic_config.pop("feature_extractor", None)
    return QPLEXMixer(
