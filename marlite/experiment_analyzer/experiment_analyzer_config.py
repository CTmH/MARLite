...
from marlite.experiment_analyzer.experiment_analyzer import ExperimentAnalyzer
...
class ExperimentAnalyzerConfig:
    def __init__(self, config_dict: dict):
        ...
        self.registered_analyzers = {
            'Default': ExperimentAnalyzer
        }

    def create_analyzer(self, analyzer_type: str = 'Default', checkpoint: str = "best") -> ExperimentAnalyzer:
        """
