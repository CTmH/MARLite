...
class AdversarialPursuit(BaseParallelWrapper):
    ...
    def _concat_action_dict(self, agent_actions, opponent_actions):
    ...
    def step(self, actions: Dict) -> tuple:
        ...
        self.opponent_actions = self.opponent_agent_group.act(opp_obs,
                                                              ...
                                                              alive_opponent,
                                                              epsilon=0.0)
        self._concat_action_dict(actions, self.opponent_actions)  # Combine actions with opponent's actions
...
class AdversarialPursuitPredator(AdversarialPursuit):
    def __init__(self, env, opponent_agent_group_config: Dict[str, Any], opp_obs_queue_len: int, channel_first: bool = False):
        super().__init__(env, opponent_agent_group_config, opp_obs_queue_len, channel_first)
    ...
    def _concat_action_dict(self, agent_actions, opponent_actions):
        return agent_actions | self.opponent_actions


class AdversarialPursuitPrey(AdversarialPursuit):
    def __init__(self, env, opponent_agent_group_config: Dict[str, Any], opp_obs_queue_len: int, channel_first: bool = False):
        super().__init__(env, opponent_agent_group_config, opp_obs_queue_len, channel_first)
    ...
    def _concat_action_dict(self, agent_actions, opponent_actions):
        return self.opponent_actions | agent_actions